...
if (count($assemblies) > 0) {
 ...
 echo '</ul>';
 echo '<a href="/admin/edit.php?id=' . $assembly['id'] . '">Редактировать</a>';
 echo ' | ';
 echo '<a href="/admin/manage.php?go=del&id=' . $assembly['id'] . '" onclick="return confirm(Вы уверены, что хотите удалить эту сборку?)">Удалить</a>';
 echo '</div>';
 }
 } else {
